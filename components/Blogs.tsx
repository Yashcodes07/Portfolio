...
Lighting variation, occlusion, scale diversity, and class imbalance are common pitfalls. Address them through dataset diversity, weighted sampling, focal loss, and robust augmentation. Also sometimes collecting labelled data for Yolov5/v8 and converting it to Yolo format is also a very difficult task.
